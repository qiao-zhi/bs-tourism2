...
function showTicketsTable(pageInfo){
    ...
    for(var i=0,length_1 = tickets.length;i<length_1;i++){
        ...
        var tr = "<tr>"
            ...
            +'<td>'+replaceNull(tickets[i].ticketname)+'</td>'
...
function deleteTicket(id){
	...
	layer.confirm('确认删除?', function(index){
		$.post("ticket/deleteTicket.html",{"id":id},function(result){
...
function updateTicket(id){
	var url = 'ticket/updateTicket.html?id='+id;
